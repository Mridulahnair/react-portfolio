    ...
    <>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <img src={image} alt={title} style={{ width: '100%', maxHeight: '200px', objectFit: 'cover', marginBottom: '1rem' }} />
            <Title order={2} style={{ marginBottom: '1rem', fontWeight: 700, fontSize: '1.5rem' }}>{title}</Title>
