...
function VideoCard({ video, title, category, content }: VideoCardProps) {
  return (
    <>
      <Paper shadow="md" p="xl" radius="md" className={classes.videoCard}>
...
const videoData = [
  {
    video:
      "https://github.com/Mridulahnair/react-portfolio/raw/refs/heads/main/src/assets/Bag.mp4",
    title: "Business type Head Shot",
...
export function CarouselCards() {
  ...
  const videoSlides = videoData.map((item) => <VideoCard {...item} />);
